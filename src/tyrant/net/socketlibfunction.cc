...
bool tyrant::net::base::InitSocket(void)
{
    bool ret = true;
...
void tyrant::net::base::DestroySocket()
{
#if defined PLATFORM_WINDOWS
    WSACleanup();
#endif
...
int tyrant::net::base::SocketNodelay(sock fd)
{
    const int flag = 1;
    return setsockopt(fd, IPPROTO_TCP, TCP_NODELAY, (char *)&flag, sizeof(flag));
}

bool ::tyrant::net::base::SocketBlock(sock fd)
{
    int err;
...
bool tyrant::net::base::SocketNonblock(sock fd)
{
    int err;
...
int ::tyrant::net::base::SocketSetSendSize(sock fd, int sd_size)
{
    return setsockopt(fd, SOL_SOCKET, SO_SNDBUF, (const char*)&sd_size, sizeof(sd_size));
}

int tyrant::net::base::SocketSetRecvSize(sock fd, int rd_size)
{
    return setsockopt(fd, SOL_SOCKET, SO_RCVBUF, (const char*)&rd_size, sizeof(rd_size));
}

sock tyrant::net::base::Connect(bool isIPV6, const std::string& server_ip, int port)
{
...
sock tyrant::net::base::Listen(bool isIPV6, const char* ip, int port, int back_num)
{
...
void tyrant::net::base::SocketClose(sock fd)
{
#if defined PLATFORM_WINDOWS
    closesocket(fd);
#else
...
std::string tyrant::net::base::GetIPOfSocket(sock fd)
{
#if defined PLATFORM_WINDOWS
...
int tyrant::net::base::SocketSend(sock fd, const char* buffer, int len)
{
...
sock tyrant::net::base::Accept(sock listenSocket, struct sockaddr* addr, socklen_t* addrLen)
{
#if defined PLATFORM_WINDOWS
...
sock tyrant::net::base::SocketCreate(int af, int type, int protocol)
{
#if defined PLATFORM_WINDOWS
