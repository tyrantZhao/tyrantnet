#ifndef __TYRANTNET_NET_SOCKETLIBFUNCTION_H__
#define __TYRANTNET_NET_SOCKETLIBFUNCTION_H__
...
namespace tyrant { namespace net { namespace base {
    bool InitSocket();
    void DestroySocket();
...
#endif // __TYRANTNET_NET_SOCKETLIBFUNCTION_H__
